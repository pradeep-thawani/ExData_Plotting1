...
plot(powerCons$Date, powerCons$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(powerCons$Date, powerCons$Global_reactive_power, type = "l", ylab = "Voltage", xlab = "datetime")
